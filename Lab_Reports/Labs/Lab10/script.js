function showСondition() {
    document.getElementById("text").innerHTML="Скласти програму для обробки одновимірного масиву. Передбачити обробку виключних ситуацій.";
    document.getElementById("outputImageOne").src="img/conditionLab10.jpg";
...
function showСode() {
    ...
    document.getElementById("outputImageOne").src="img/codeLab10.1.png";
    document.getElementById("outputImageOne").alt="Не можемо знайти скріншот-(";
	document.getElementById("outputImageTwo").src="img/codeLab10.2.png";
    document.getElementById("outputImageTwo").alt="Не можемо знайти скріншот-(";
	document.getElementById("outputImageThree").src="img/codeLab10.3.png";
    document.getElementById("outputImageThree").alt="Не можемо знайти скріншот-(";
...
function showOutput() {
    ...
    document.getElementById("outputImageOne").src="img/outputLab10.1.jpg";
    document.getElementById("outputImageOne").alt="Не можемо знайти скріншот-(";
	document.getElementById("outputImageTwo").src="img/outputLab10.2.jpg";
    document.getElementById("outputImageTwo").alt="Не можемо знайти скріншот-(";
	document.getElementById("outputImageThree").src="img/nothing.jpg";
    document.getElementById("outputImageThree").alt="Не можемо знайти скріншот-(";
