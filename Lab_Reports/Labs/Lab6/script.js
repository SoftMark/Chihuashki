function showСondition() {
    document.getElementById("text").innerHTML="  У рядку символів визначити слова-паліндроми, які однаково читаються справа наліво і навпаки. Знайти найбільшу довжину цих слів. Якщо таких слів немає, то з кожного слова на непарній позиції вилучити голосні та надрукуйте їх.";
...
function showСode() {
    ...
    document.getElementById("outputImageOne").src="img/codeLab6.1.png";
    document.getElementById("outputImageOne").alt="Не можемо знайти скріншот-(";
	document.getElementById("outputImageTwo").src="img/codeLab6.2.png";
    document.getElementById("outputImageTwo").alt="Не можемо знайти скріншот-(";
	document.getElementById("outputImageThree").src="img/codeLab6.3.png";
    document.getElementById("outputImageThree").alt="Не можемо знайти скріншот-(";
...
function showOutput() {
    ...
    document.getElementById("outputImageOne").src="img/outputLab6.jpg";
    document.getElementById("outputImageOne").alt="Не можемо знайти скріншот-(";
	document.getElementById("outputImageTwo").src="img/nothing.jpg";
    document.getElementById("outputImageTwo").alt="Не можемо знайти скріншот-(";
	document.getElementById("outputImageThree").src="img/nothing.jpg";
